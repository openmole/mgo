...
//      gs <- tournament[M, I, (Lazy[Int], Lazy[Double])](
//        paretoRankingMinAndCrowdingDiversity[M, I](fitnessWithReplications(history, historyAggregation)),
//        lambda + 1
//      ) andThen
//        mapPureB[M, I, Vector[Double]](genome andThen genomeValues) andThen
