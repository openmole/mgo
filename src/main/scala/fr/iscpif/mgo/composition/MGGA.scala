...
//class MGGA[CG <: Genome, CF <: Fitness, CMF, CA, CSTATE](
//    val archiveComponent: Archive { type A = CA },
...
//    val genomeFactoryComponent: GenomeFactory { type G = CG },
...
//    val lambda: Int) extends Evolution with Elitism with Breeding {
//
//  type A = CA
//  type G = CG
//  type F = CF
