...
import org.openmole.tools.mgo.ga.DistributionIndex
import org.openmole.tools.mgo.tools.Random._

class SBXBoundedCrossoverMeta[G <: GAGenome with DistributionIndex, F <: GAGenomeFactory[G]](
  ...
  def crossOver (genomes : IndexedSeq [G], factory: F) (implicit aprng : Random) = {
    ...
    crossOver(g1, g2, distributionIndex * distributionIndexScale, factory)
  }
